...
export default function LandingPage() {
  ...
  return (
    <div className="relative bg-white overflow-x-hidden font-[var(--font-open-sans)]">
      ...
      {/* Black Section - Menimpa bagian putih, dimulai tepat di bawah foto */}
      <div 
        className="relative w-full bg-black text-white z-40 -mt-12 lg:-mt-20"
        style={{
          boxShadow: `0 -${10 + shadowSpread}px ${20 + shadowSpread * 2}px rgba(0, 0, 0, 0.3)`
        }}
      >
        <div className="w-full">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-12 lg:py-16 space-y-16 lg:space-y-20">
            ...
            <section>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4 sm:gap-6">
                ...
                {Array.from({ length: 6 }).map((_, i) => (
                  <div key={`favorit-${i}`} className="aspect-[2/3] bg-gray-800 rounded-lg flex items-center justify-center hover:opacity-80 transition-opacity cursor-pointer">
                    <span className="text-gray-500 text-sm">Anime {i + 1}</span>
                  </div>
                ))}
              </div>
            </section>
            ...
            <section>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4 sm:gap-6">
                {/* Placeholder for anime cards */}
                {Array.from({ length: 6 }).map((_, i) => (
                  <div key={`highlight-${i}`} className="aspect-[2/3] bg-gray-800 rounded-lg flex items-center justify-center hover:opacity-80 transition-opacity cursor-pointer">
                    <span className="text-gray-500 text-sm">Anime {i + 1}</span>
                  </div>
                ))}
              </div>
            ...
            <section>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4 sm:gap-6">
                {/* Placeholder for anime cards */}
                {Array.from({ length: 6 }).map((_, i) => (
                  <div key={`newest-${i}`} className="aspect-[2/3] bg-gray-800 rounded-lg flex items-center justify-center hover:opacity-80 transition-opacity cursor-pointer">
                    <span className="text-gray-500 text-sm">Anime {i + 1}</span>
                  </div>
                ))}
              </div>
          ...
          {/* Credit Text */}
          <div className="w-full border-t border-gray-800 py-6 lg:py-8">
            <p 
